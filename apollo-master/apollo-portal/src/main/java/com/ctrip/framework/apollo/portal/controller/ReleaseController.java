...
public class ReleaseController {
  ...
  @RequestMapping(value = "/envs/releases/testDbConnection/testDbConnection", method = RequestMethod.POST)
  public String testDbConnection(@RequestBody Map<String,String> requestMap) throws SQLException, ClassNotFoundException {

    String username = requestMap.get("username");
    String password = requestMap.get("password");
    String url = requestMap.get("url");
    String driver = requestMap.get("driver");
  ...
  @RequestMapping(value = "/envs/releases/testCacheConnection/testCacheConnection", method = RequestMethod.POST)
  public String testCacheConnection(@RequestBody Map<String,String> requestMap){

    String port = requestMap.get("port");
    String host = requestMap.get("host");
    String password = requestMap.get("password");
