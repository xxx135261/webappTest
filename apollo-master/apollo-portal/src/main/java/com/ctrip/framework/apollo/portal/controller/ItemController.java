...
public class ItemController {
  ...
  @PreAuthorize(value = "@permissionValidator.hasAddDelNamespacePermission(#appId, #namespaceName)")
  ...
  @PreAuthorize(value = "@permissionValidator.hasModifyValNamespacePermission(#appId, #namespaceName)")
