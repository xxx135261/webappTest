appService.service('ReleaseService', ['$resource', '$q', function ($resource, $q) {
    var resource = $resource('', {}, {
        ...
        test_db_connection: {
            method:'POST',
            url:'/envs/releases/testDbConnection/testDbConnection'
        },
        test_cache_connection: {
            method:'POST',
            url:'/envs/releases/testCacheConnection/testCacheConnection'
        },
        release: {
            method: 'POST',
    ...
    function testDbConnection(driver, url, username, password) {
        var d = $q.defer();
        resource.test_db_connection({
            driver: driver,
            url: url,
            username: username,
            password: password
    ...
    function testCacheConnection(port, host, password) {
        var d = $q.defer();
        resource.test_cache_connection({
            port: port,
            host: host,
            password: password
        }, function (result) {
    ...
    return {
        ...
        testCacheConnection: testCacheConnection
    }
}]);
