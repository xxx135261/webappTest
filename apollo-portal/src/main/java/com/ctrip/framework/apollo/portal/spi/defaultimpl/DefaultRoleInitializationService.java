...
public class DefaultRoleInitializationService implements RoleInitializationService {
  ...
  @Override
  public void initAppRoleNamespacePermissions(String appId, String namespaceName) {

  }

  protected void createAppMasterRole(String appId, String operator) {
  ...
  protected Permission createPermission(String targetId, String permissionType, String operator) {
  ...
  protected Role createRole(String roleName, String operator) {
    Role role = new Role();
  ...
  protected void createNamespaceRole(String appId, String namespaceName, String permissionType,
