appService.service('PermissionService', ['$resource', '$q', function ($resource, $q) {
    var permission_resource = $resource('', {}, {
        ...
        get_app_role_users: {
            method: 'GET',
            url: '/apps/:appId/role_users/Master'
        },
        get_app_impl_role_users: {
            method: 'GET',
            url: '/apps/:appId/role_users/Implementation'
        },
    ...
    return {
        ...
        has_modify_namespace_permission: function (appId, namespaceName) {
            return $q.all(new Array(
                this.has_add_or_del_namespace_permission(appId, namespaceName),
                this.has_modify_val_namespace_permission(appId, namespaceName)
            ));
        },
        has_add_or_del_namespace_permission: function (appId, namespaceName) {
            return hasNamespacePermission(appId, namespaceName, 'AddOrDelNamespace');
        },
        has_modify_val_namespace_permission: function (appId, namespaceName) {
            return hasNamespacePermission(appId, namespaceName, 'ModifyValNamespace');
        },
        ...
        get_app_impl_role_users: function (appId) {
            var d = $q.defer();
            permission_resource.get_app_impl_role_users({
                    appId: appId
                },
                function (result) {
                    d.resolve(result);
        ...
        assign_impl_role: function (appId, user) {
            var d = $q.defer();
            permission_resource.assign_app_role_to_user({
                    appId: appId,
        ...
        remove_impl_role: function (appId, user) {
            var d = $q.defer();
            permission_resource.remove_app_role_from_user({
                    appId: appId,
                    roleType: 'Implementation',
